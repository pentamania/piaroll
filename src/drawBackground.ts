import { TrackBackgroundParams, TRACK_DEFAULT_EVEN_COLOR, TRACK_MAJOR_LINE_COLOR, TRACK_MINOR_LINE_COLOR, TRACK_DEFAULT_DIV_NUM, TRACK_DEFAULT_ODD_COLOR, TRACK_DEFAULT_HEIGHT, TRACK_DEFAULT_BAR_WIDTH, TRACK_MAJOR_LINE_WIDTH, TRACK_MINOR_LINE_WIDTH } from "./config";
const DEFAULT_PARAMS = {
  width: TRACK_DEFAULT_BAR_WIDTH,
